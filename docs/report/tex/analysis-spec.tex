...
\begin{table*}[ht]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    Before & Be able to calculate and display a landing pattern for a given target & Must \\
           & Be able to calculate landing patterns for a target's current wind conditions & Must \\
    During & Log the user's jump number, maximum speed and freefall time & Must \\
           ...
           & Be able to give the user warnings of obstacles while under canopy & Should \\
