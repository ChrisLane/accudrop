% !TEX root = ../main.tex
\section{Background}\label{sec:further-background}
...
\begin{figure}[ht]
  ...
  \begin{scaletikzpicturetowidth}{0.3\linewidth}
    \begin{tikzpicture}[scale=\tikzscale]
      ...
      \draw[postaction={decorate}] (4,0)--(0,0) node[at start,above]{\SI{180}{\metre}} node[midway,above]{base}; % base
  ...
  \caption{A typical skydiver landing pattern with turn altitudes at \SI{300}{\metre}, \SI{180}{\metre} and \SI{90}{\metre}}\label{fig:landing-pattern}
\end{figure}
