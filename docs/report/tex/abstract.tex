...
\begin{abstract}
  ...
  % Solution and method
  This paper describes how we created a proof of concept Android smartphone app to aid the learning progression of a new skydiver and provide them with insight into their skydives. The app can give the user pre-jump (skydive) information for planning, track a skydiver's position during a jump and present collected data for review by the user post-jump.
